...
* Check existing issues to verify that an [bug][bug issues] or [feature request][feature request issues] has not already been submitted for the same problem or feature.
