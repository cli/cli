...
func TestPRCreate_web(t *testing.T) {
	...
	eq(t, output.String(), "")
	eq(t, utils.Compact(output.Stderr()), utils.Compact("Creating pull request for feature into master in OWNER/REPO Opening github.com/OWNER/REPO/compare/master...feature in your browser."))
