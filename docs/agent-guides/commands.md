...
Read this before editing or reviewing command wiring, flags, prompts, help, or
output. The [root contract](../../AGENTS.md) governs contribution eligibility
and compatibility; this guide supplies command-specific conventions.
