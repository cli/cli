...
Read this before editing or reviewing tests, fixtures, or generated test doubles.
Use the affected-package loop and pre-commit gates in the
[root contract](../../AGENTS.md#local-development-and-validation).
