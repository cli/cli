...
func NewCmdEdit(f *cmdutil.Factory, runF func(options *EditOptions) error) *cobra.Command {
	...
	cmdutil.NilStringFlag(cmd, &opts.Edits.SquashMergeCommitTitle, "squash-merge-commit-title", "", "Set the default value for a squash merge commit title {PR_TITLE,COMMIT_OR_PR_TITLE}")
	cmdutil.NilStringFlag(cmd, &opts.Edits.SquashMergeCommitMessage, "squash-merge-commit-message", "", "Set the default value for a squash merge commit message {PR_BODY,COMMIT_MESSAGES,BLANK}")
