	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{
			"help:arguments": heredoc.Docf(`
				...
				- by number for issue or pull request, e.g. %[1]s123%[1]s; or
				- by path for opening folders and files, e.g. %[1]scmd/gh/main.go%[1]s; or
				- by commit SHA
			`, "`"),
			"help:environment": heredoc.Docf(`
				To configure a web browser other than the default, use the %[1]sBROWSER%[1]s environment variable.
			`, "`"),
		},
		GroupID: "core",
