	...
	tests := map[string]struct {
		...
		"with comments flag": {
			...
			expectedOutputs: []string{
				...
				`Comment 5`,
				`g14a \(Contributor\) • Apr  1, 2021 • Edited • Newest comment`,
				`@vilmibm @ampinsk  I tried solving this. Issues and PRs look like the`,
				`following respectively. Does it look okay or can it be better from a design`,
				`perspective?`,
				`## Issues:`,
				`Image: Image → https://user-images.githubusercontent.com/17702388/113286902-`,
				`6ea20500-930a-11eb-8860-754107c67b22.png`,
				`## PRs:`,
				`Image: Image → https://user-images.githubusercontent.com/17702388/113286974-`,
				`8c6f6a00-930a-11eb-98da-41e159056438.png Do you want to take a look at the PR`,
				`which fixes this?`,
				`View this issue on GitHub: https://github.com/OWNER/REPO/issues/123`,
			},
		},
