...
func TestNormalizeReference(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			pathSeparator:  '/',
			expectedResult: "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa1111111111111111111111111111111",
		...
		},
		{
			...
			pathSeparator:  '/',
			expectedResult: "sha512:abcdef1234567890abcdefabcdef1234567890abcdefabcdef1234567890abcdefabcdef1234567890abcdefabcdef1234567890abcdefabcdef1234567890ab",
			expectedType:   digestArtifactType,
			expectedError:  false,
		},
		{
