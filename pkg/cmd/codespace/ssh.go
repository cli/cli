...
func newSSHCmd(app *App) *cobra.Command {
	...
	sshCmd.Flags().BoolVarP(&opts.codespacesKeypair, "codespaces-keypair", "k", false, fmt.Sprintf("Always use a keypair generated by codespaces (%s)", automaticPrivateKeyName))
