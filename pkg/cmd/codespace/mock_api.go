...
// 			},
// 			ListCodespacesFunc: func(ctx context.Context, num int) ([]*api.Codespace, error) {
...
func (mock *apiClientMock) ListCodespaces(ctx context.Context, num int) ([]*api.Codespace, error) {
	...
	return mock.ListCodespacesFunc(ctx, num)
}
