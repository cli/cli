...
// 			CreateFunc: func(createOptions *CreateOptions) error {
...
type ExtensionManagerMock struct {
	...
	calls struct {
		...
		Create []struct {
			// CreateOptions is the createOptions argument value.
...
func (mock *ExtensionManagerMock) Create(createOptions *CreateOptions) error {
	...
	return mock.CreateFunc(createOptions)
}
