...
func PollPostCreateStates(ctx context.Context, progress progressIndicator, apiClient liveshareApiClient, codespace *api.Codespace, poller func([]PostCreateState)) (err error) {
