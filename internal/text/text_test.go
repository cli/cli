...
func TestDisplayURL(t *testing.T) {
	tests := []struct {
		...
		{
			name: "preserve escaped path characters without scheme",
			url:  "github.com/OWNER/REPO/compare/master...test-%22quoted%22-branch-pr?body=&expand=1",
			want: "https://github.com/OWNER/REPO/compare/master...test-%22quoted%22-branch-pr",
		},
		{
